...
==================
    """,
    # Community petroleum stack: Cybrosys kit replaces account_accountant.
    # Deferred reports are installed inactive (need accountant deferred_* fields).
    ...
    'data': [
        ...
        'data/hide_community_duplicate_menus.xml',
    ],
