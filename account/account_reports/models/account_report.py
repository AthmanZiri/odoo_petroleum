...
class AccountReport(models.Model):
    ...
    # Explicit short relation: kit wizards also _inherit account.report, and the
    # auto name account_*_account_report_horizontal_group_rel exceeds PG's 63-char limit.
    horizontal_group_ids = fields.Many2many(
        string="Horizontal Groups",
        comodel_name='account.report.horizontal.group',
        relation='account_report_horizontal_grp_rel',
        column1='report_id',
