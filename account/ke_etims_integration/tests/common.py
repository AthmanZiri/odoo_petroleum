...
class TestKeEdiCommon(TestAccountMoveSendCommon):
    ...
    def setUpClass(cls):
        ...
        cls.product_service = cls.env['product.product'].create([{
            ...
            'l10n_ke_packaging_unit_id': cls.env.ref('ke_etims_integration.code_17_OU').id,
    ...
    def patch_session(self, responses):
        """ Patch requests.Session in ke_etims_integration/models/company.py """
        ...
        class MockedSession:
            ...
            def post(self, url, json=None, timeout=None):
                ...
                module = 'ke_etims_integration_stock' if service in stock_services else 'ke_etims_integration'
        ...
        with mock.patch('odoo.addons.ke_etims_integration.models.res_company.requests.Session', side_effect=MockedSession, autospec=True) as mock_session:
            yield mock_session
    ...
    def create_reversal(self, invoice, is_modify=False):
        ...
        wizard_reverse.write({
            'reason': 'Return',
            'l10n_ke_reason_code_id': self.env.ref('ke_etims_integration.code_32_06').id,
        })
