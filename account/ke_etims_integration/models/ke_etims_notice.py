...
class KeEtimsNotice(models.Model):
    _name = 'ke_etims_integration.notice'
    ...
    @api.model
    def _cron_ke_etims_get_notices(self):
        ...
        last_request_date = self.env['ir.config_parameter'].get_param('ke_etims.last_notice_request_date', '20180101000000')
