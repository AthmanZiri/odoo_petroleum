...
class KeEtimsCode(models.Model):
    _name = 'ke_etims_integration.code'
            ...
            vals += [
                {
                    ...
                    'tax_rate': code_type == '04' and float(code['userDfnCd1']),
                }
    ...
    def _create_or_update_from_vals(self, create_vals):
        ...
        :param list[dict] create_vals: list of ke_etims_integration.code creation vals.
        ...
        model_data_values = [
            {
                ...
                'model': 'ke_etims_integration.code',
                'module': 'ke_etims_integration',
                'res_id': code.id,
                'noupdate': True,
            }
            for code in created
    ...
    def _cron_get_codes_from_device(self):
        ...
        last_request_date = self.env['ir.config_parameter'].get_param('ke_etims.last_code_request_date', '20180101000000')
        ...
        self.env['ir.config_parameter'].sudo().set_param('ke_etims.last_code_request_date', format_etims_datetime(fields.Datetime.now()))
