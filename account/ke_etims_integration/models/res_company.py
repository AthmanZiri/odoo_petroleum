...
class ResCompany(models.Model):
    ...
    def action_l10n_ke_get_items(self):
        ...
        """
        last_request_date = self.env['ir.config_parameter'].get_param('ke_etims_integration.last_fetch_items_request_date', '20180101000000')
    ...
    def _l10n_ke_get_demo_response(self, urlext, content):
        ...
        module = 'ke_etims_integration_stock' if urlext in stock_services else 'ke_etims_integration'
